...
class ProductView extends Component {
    ...
    render() {
        ...
        // console.log('val *ProductViewFromHome*', this.props.val);
                    ...
                    <View style={{ flex: 2.9 }} >
                        <Card style={{ height: 120 }}>
                            <View style={{ flexDirection: 'column' }}>
                                ...
                                <View style={{ width: '90%' }}>
                                    <Text style={{ fontSize: 14, fontWeight: 'bold', marginLeft: 10, marginTop: 5, color: 'black' }}>
                                    {val.name}
                                    </Text>
                                </View>
                                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                    ...
                                    <View style={{ flexDirection: 'row', marginTop: 10, marginRight: 15 }}>
                                        ...
                                        <Text onPress={() => navigate("Cart", { val })} style={{ fontSize: 16, color: '#1A5CAD', fontWeight: 'bold', marginTop: 5 }}>Cart it</Text>
                                        {/* 8C8E8F */}
